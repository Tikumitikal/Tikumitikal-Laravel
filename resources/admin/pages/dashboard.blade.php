                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <p class="mb-1 small text-muted">Jumlah Reservasi Bulan Ini</p>
                                        <span class="h3">{{ $totalreservasibulanini }}</span><br />
                                    </div>
                                </div> <!-- /. row -->
                            </div> <!-- /. card-body -->
                        </div> <!-- /. card -->
                    ...
                    <div class="col-md-4">
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <p class="mb-1 small text-muted">Jumlah Product</p>
                                        <span class="h3">{{ $totalproduct }}</span><br />
                                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <p class="mb-1 small text-muted">Jumlah Kategori</p>
                                        <span class="h3">{{ $totalkategori }}</span><br />
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row mt-1 align-items-center">
                                <div class="col-12 col-lg-4 text-left pl-4">
                                    ...
                                    <span class="h3">Reservasi</span>
                                    {{-- <span class="small text-muted">+20%</span> --}}
                                    {{-- <span class="fe fe-arrow-up text-success fe-12"></span> --}}
                                    <p class="text-muted mt-2"> Menampilkan Jumlah Reservasi Hari Ini</p>
                                </div>
...
@section('script')
    <script>
        var datareservasi = {!! json_encode($labeldata) !!};
        var datatanggal = {!! json_encode($labeldate) !!};
