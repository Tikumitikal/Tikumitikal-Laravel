...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="mb-2 page-title">Data Meja</h2>
                                            ...
                                            <div class="modal fade" id="deleteModal{{ $data->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="/datameja/{{ $data->id }}" method="post">
                                                            @csrf
                                                            @method('delete')
                                                        ...
                                                        <form action="/datameja/{{ $data->id }}" method="POST">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" value="{{ $data->no_meja }}"
                                                                        name="no_meja" class="form-control"
                                                                        id="recipient-name">
                                                                </div>
                                ...
                                <div class="modal fade" id="addModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="/datameja" method="POST">
                                                @csrf
                                                @method('POST')
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="" name="no_meja"
